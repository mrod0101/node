...
## 2021-12-16, Version 17.3.0 (Current), @danielleadams
...
* \[[`fdbba67523`](https://github.com/nodejs/node/commit/fdbba67523)] - **assert**: prefer reference comparison over string comparison (Darshan Sen) [#41015](https://github.com/nodejs/node/pull/41015)
...
* \[[`437baf3c51`](https://github.com/nodejs/node/commit/437baf3c51)] - **build**: update openssl config generator Dockerfile (Richard Lau) [#41177](https://github.com/nodejs/node/pull/41177)
* \[[`c658881551`](https://github.com/nodejs/node/commit/c658881551)] - **build**: use '<(python)' instead of 'python' (Cheng Zhao) [#41146](https://github.com/nodejs/node/pull/41146)
* \[[`de9ec3196f`](https://github.com/nodejs/node/commit/de9ec3196f)] - **build**: fix comment-labeled workflow (Mestery) [#41176](https://github.com/nodejs/node/pull/41176)
* \[[`a18e88669d`](https://github.com/nodejs/node/commit/a18e88669d)] - **build**: use gh cli in workflows file (Mestery) [#40985](https://github.com/nodejs/node/pull/40985)
...
* \[[`da596bf1d2`](https://github.com/nodejs/node/commit/da596bf1d2)] - **build,tools**: automate enforcement of emeritus criteria (Rich Trott) [#41155](https://github.com/nodejs/node/pull/41155)
...
* \[[`bb719c0792`](https://github.com/nodejs/node/commit/bb719c0792)] - **deps**: update archs files for quictls/openssl-3.0.1+quic (Richard Lau) [#41177](https://github.com/nodejs/node/pull/41177)
* \[[`7b0f39a8e9`](https://github.com/nodejs/node/commit/7b0f39a8e9)] - **deps**: upgrade openssl sources to quictls/openssl-3.0.1+quic (Richard Lau) [#41177](https://github.com/nodejs/node/pull/41177)
...
* \[[`adf727a0ad`](https://github.com/nodejs/node/commit/adf727a0ad)] - **doc**: fix closing parenthesis (AlphaDio) [#41190](https://github.com/nodejs/node/pull/41190)
* \[[`f530229c96`](https://github.com/nodejs/node/commit/f530229c96)] - **doc**: add security steward on/offboarding steps (Michael Dawson) [#41129](https://github.com/nodejs/node/pull/41129)
* \[[`af2f2ad7a7`](https://github.com/nodejs/node/commit/af2f2ad7a7)] - **doc**: align module resolve algorithm with implementation (Qingyu Deng) [#38837](https://github.com/nodejs/node/pull/38837)
...
* \[[`f73728bdf9`](https://github.com/nodejs/node/commit/f73728bdf9)] - **(SEMVER-MINOR)** **loader**: return package format from defaultResolve if known (Gabriel Bota) [#40980](https://github.com/nodejs/node/pull/40980)
* \[[`0e4662df83`](https://github.com/nodejs/node/commit/0e4662df83)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#41154](https://github.com/nodejs/node/pull/41154)
* \[[`badd14121c`](https://github.com/nodejs/node/commit/badd14121c)] - **meta**: move to emeritus automatically after 18 months (Rich Trott) [#41155](https://github.com/nodejs/node/pull/41155)
* \[[`b2ef99a453`](https://github.com/nodejs/node/commit/b2ef99a453)] - **meta**: move silverwind to emeriti (Roman Reiss) [#41171](https://github.com/nodejs/node/pull/41171)
...
* \[[`6906948913`](https://github.com/nodejs/node/commit/6906948913)] - **(SEMVER-MINOR)** **process**: add `getActiveResourcesInfo()` (Darshan Sen) [#40813](https://github.com/nodejs/node/pull/40813)
...
* \[[`9b0cafda7a`](https://github.com/nodejs/node/commit/9b0cafda7a)] - **stream**: add isErrored helper (Robert Nagy) [#41121](https://github.com/nodejs/node/pull/41121)
...
* \[[`4c81dd2c5e`](https://github.com/nodejs/node/commit/4c81dd2c5e)] - **test**: do not load absolute path crypto engines twice (Richard Lau) [#41177](https://github.com/nodejs/node/pull/41177)
